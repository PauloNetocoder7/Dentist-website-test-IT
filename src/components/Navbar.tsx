      ...
      <div className="bg-sky-900 text-white py-2 px-8 hidden sm:block">
        <div className="max-w-7xl mx-auto flex justify-between items-center text-xs font-medium">
          <div className="flex gap-6">
            <span className="flex items-center gap-1.5 font-medium">📍 Via della Salute 123, Città del Sorriso</span>
            <a href="tel:5551234567" className="flex items-center gap-1.5 font-medium hover:text-sky-200 transition-colors">
              📞 (555) 123-4567
            </a>
          </div>
          <div className="flex gap-6 items-center">
            <span>Lun - Gio: 8:00 - 17:00</span>
            <span className="opacity-70 text-[10px] uppercase font-bold tracking-wider">Servizio di Emergenza Disponibile</span>
          </div>
        </div>
      </div>
        ...
        <div className="flex justify-between items-center">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[10px] text-sky-600 font-bold uppercase tracking-[0.2em]">Clinica & Estetica</p>
              <div className="flex gap-1.5 mt-1 items-center">
                <img src="https://flagcdn.com/w40/it.png" alt="Italia" className="h-3 w-5 object-cover rounded-[1px] shadow-xs border border-slate-200/50" referrerPolicy="no-referrer" />
              </div>
            </div>
          </div>
