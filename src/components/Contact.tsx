      ...
      <div className="container mx-auto px-8 lg:px-16 relative">
        <div className="grid lg:grid-cols-2 gap-20 items-stretch relative z-10">
          <div className="flex flex-col justify-center">
            <span className="text-sky-600 font-bold text-sm tracking-[0.2em] uppercase mb-4 block">Contattaci</span>
            <h2 className="text-4xl font-bold text-slate-900 mb-6">Insieme per la Tua Salute Orale.</h2>
            <p className="text-slate-600 text-lg mb-12 max-w-md leading-relaxed">
              Siamo situati in una posizione comoda e facilmente accessibile. Mettiti in contatto con noi per prenotare la tua prossima visita o per qualsiasi domanda sui nostri trattamenti.
            </p>

            <div className="space-y-6">
              {[
                { icon: MapPin, title: 'La Nostra Sede', detail: 'Via della Salute 123, Città del Sorriso' },
                { icon: Phone, title: 'Chiamaci', detail: '(555) 123-4567' },
                { icon: Clock, title: 'Orari di Apertura', detail: 'Lun - Gio: 8:00 - 17:00' }
              ].map((item, i) => (
          ...
          >
            <h3 className="text-2xl font-bold mb-8 text-sky-900">Richiedi Informazioni</h3>
